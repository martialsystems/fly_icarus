...
from fly_icarus.paths import TEMPLATES
from icarusforge.gate import FLYWIRE_N, MALECNS_N, require_engine, require_templates
...
def load_W() -> np.ndarray:
    ...
    require_templates(
        ...
        hop_count_extract=spec.get("kind") == "hop_count_extract",
    )
