...
from icarusforge._bootstrap import ensure_paths

ensure_paths()

from graphforge.product_law import LawBlockedError, require_law

from icarusforge.graphs.assay_order import build_graph as build_order
from icarusforge.graphs.claim_bans import build_graph as build_claims
from icarusforge.graphs.engine_shared import N_TEMPLATES_MAX, build_graph as build_engine
from icarusforge.graphs.template_identity import (
    FLYWIRE_N,
    MALECNS_N,
    SLICE_N_MAX,
    build_graph as build_templates,
)
from icarusforge.graphs.wiring_frozen import build_graph as build_wiring
...
def require_templates(
    *,
    ...
    require_law(
        ...
        allow_decisions=["allow"],
        law_id="icarus.template_identity",
